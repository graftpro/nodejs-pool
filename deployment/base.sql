...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon','address','graft','string','Graft Daemon RPC IP');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon','port','18081','int','Graft Daemon RPC Port');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet','address','graft','string','graft Daemon RPC Wallet IP');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet','port','18082','int','Graft Daemon RPC Wallet Port');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout','feesForTXN','10','int','Amount of GRF that is left from the fees to pay miner fees.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('pool','geoDNS','','string','geoDNS enabled address for the pool.');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('api','authKey','','string','Auth key sent with all Websocket frames for validation');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('api','secKey','','string','HMAC key for Passwords.  JWT Secret Key');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general','adminEmail','','string','Admin e-mail to send e-mails to when something isn''t working right.');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout','fee','10000000000','int','Atomic units of coin to use ass a fee');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout','unlock_time','0','int','Number of blocks assumed before the payout unlocks.');
